...
def main(url, token, parent_prefix, include_parent_prefix, ip_range_role, config, template_path, log_level):
    logging.basicConfig(
        level=log_level, 
